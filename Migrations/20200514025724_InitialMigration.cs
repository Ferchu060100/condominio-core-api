        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    BinaryCode = table.Column<string>(nullable: true),
                    ProjectId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentFiles_Apartments_ApartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentFiles_ApartmentId",
                table: "ApartmentFiles",
                column: "ApartmentId");
